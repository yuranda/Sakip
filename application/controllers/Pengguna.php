...
class Pengguna extends Sakip {
	...
	public function index() 
	{
		...
		$this->template->view('Sakip/pengguna/data-pengguna', $this->data);
	}
	...
	public function create()
	{
		...
		$this->template->view('Sakip/pengguna/create-pengguna', $this->data);
	}
	...
	public function update($param = 0)
	{
		...
		$this->template->view('Sakip/pengguna/update-pengguna', $this->data);
	}
