	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			<div class="navbar-header">
                <img src="<?php echo base_url("assets/Sakip/img/logo-main.png"); ?>" class="logo-head" alt="Logo" width="440">
			</div>
...
<div class="navbar navbar-inverse navbar-fixed-bottom">
   <div class="container">
      <small class="navbar-text pull-left">&copy; SEKRETARIAT DAERAH KABUPATEN BANGKA TENGAH 2018</small>
      <small class="navbar-text pull-right">Develop By <a href="http://teitramega.co.id" target="_blank">Teitra Mega</a> </small>
   </div>
</div>	
